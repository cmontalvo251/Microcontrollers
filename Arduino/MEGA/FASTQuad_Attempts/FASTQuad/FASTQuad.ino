...
//PRINTSERIAL TO MAKE THE CODE RUN FASTER
...
//VL53L0X_RangingMeasurementData_t altitude_measurement;
//float altitude = 0, altitude0 = 0;
...
//  if (!lox.begin()) {
 //   Serial.println(F("Failed to boot VL53L0X"));
  ...
  //for (int idx = 0;idx<N;idx++) {
   // lox.rangingTest(&altitude_measurement,false);
   // if (altitude_measurement.RangeStatus != 4) {
   //   altitude = altitude_measurement.RangeMilliMeter;
   // }
   // altitude0 += altitude;
  //}
  //altitude0 /= (N-1);
...
//  }
  ...
  if (autopilot) {
    ...
    //Measure altitude to get Nominal 
   // lox.rangingTest(&altitude_measurement,false);
    //if (altitude_measurement.RangeStatus != 4) {
    //  altitude = altitude_measurement.RangeMilliMeter-altitude0;
    //}
    //float kp_altitude = 1.0;
    //float altitude_command = 50.0;
    int nominal_val = 1525;// + kp_altitude*(altitude_command - altitude); //1560 //We tested this using cleanflight and it seems like that is correct.
