...
void loop()                     // run over and over again
{
  ...
  if (millis() - timer > 1000) { 
    ...
    //if (GPS.fix) {
      ...
      Serial.print(" Location: ");
      Serial.print(GPS.latitudeDegrees, 2);
      Serial.print(", "); 
      Serial.print(GPS.longitudeDegrees, 2);
      
      Serial.print(" Speed: "); Serial.print(GPS.speed);
   ...
   Serial.print("Psi: ");   Serial.print(euler.x());
   Serial.print(" Theta: ");   Serial.print(euler.y());
   Serial.print(" Phi: ");   Serial.print(euler.z());
   Serial.print(" R: ");   Serial.print(rate.z());
   Serial.print(" Q: ");   Serial.print(rate.y());
   Serial.print(" P: ");   Serial.print(rate.x());
   Serial.print(" Ax: ");   Serial.print(lin_accel.x());
   Serial.print(" Ay: ");   Serial.print(lin_accel.y());
   Serial.print(" Az: ");   Serial.print(lin_accel.z());
   Serial.print("\n");
  }
}
