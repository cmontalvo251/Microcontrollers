...
void buzzer::buzzerSetup()
{
	...
	// start zero output
	pinMode(BUZZER_OUTPUT_PIN, OUTPUT); ///buzzer is connected to pin 5. Not sure what the hardware looks like but whatever.
	buzzStop();  ///buzzstop sends a voltage of zero to the buzzer. or rather it uses the analogwrite function to do that
}
