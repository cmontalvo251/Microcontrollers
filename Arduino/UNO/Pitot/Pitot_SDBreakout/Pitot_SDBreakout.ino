#include <SD.h>
//Note this only works when you have the SD breakout board plugged in. If you use the GPS_Shield you need to use different code
//Oh this also assumes you have a button to start and stop taking data
