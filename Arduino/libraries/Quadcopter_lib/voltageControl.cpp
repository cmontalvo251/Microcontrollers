...
{
	pinMode(VOLTAGECONTROL_INPUT_PIN, INPUT); ///If you head over to voltagecontrol.h you'll see that he uses the same
	///3S battery to power the arduino. The 5V input is plugged into A0. Not sure why it's A0 but it doesn't really matter.
