# This is the adafruit_thermistor module that I modified ever so slightly with some print statements
...
class Thermistor:
    ...
    **Quickstart: Importing and using the adafruit_thermistor library**
    ...
    def resistance(self) -> float:
        ...
        if self.high_side:
            print('High side is true....so thermistor is connected to Vo')
