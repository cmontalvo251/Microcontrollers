...
from adafruit_bme280 import basic as adafruit_bme280  ###THIS WE ARE GOING TO NEED TO CHANGE
...
bme280 = adafruit_bme280.Adafruit_BME280_I2C(i2c) ###THIS WILL NEED TO CHANGE BASED ON YOUR PRESSURE SENSOR
...
while True:
    ...
    #and PTH sensor - WE HAVE TO MAKE SURE THAT OUR BME280 OR LPS22 HAS
    ##THESE SENSORS
    p = bme280.pressure
    Te = bme280.temperature
    rH = bme280.humidity
