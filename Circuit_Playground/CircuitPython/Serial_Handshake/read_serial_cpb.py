...
class CPX:
    ...
    def read(self):
        ...
        self.nornm2 = np.sqrt(self.ax**2 + self.ay**2 + self.az**2)
        ...
        outstring = str(self.t) + " " + str(self.x) + " " + str(self.y) + " " + str(self.z) + " " + str(self.ax) + " " + str(self.ay) + " " + str(self.az) + " " + str(self.gx) + " " + str(self.gy) + " " + str(self.gz) + "\n"
