...
if switch.value == False:
    file = open('Method3_Dataloggin.txt','w')
    FILEOPEN = True
else:
...
while True:
    ...
    if switch.value == False:
        print('File currently logging. The first pixel will be blinking if this is working.')
        ...
        print('File not logging. Flip the switch and then hit reset.')
        if FILEOPEN == True:
            print('FILE CLOSED!!!')
            file.close()
            FILEOPEN = False
    ...
    time.sleep(0.2)# Write your code here :-)# Write your code here :-)
