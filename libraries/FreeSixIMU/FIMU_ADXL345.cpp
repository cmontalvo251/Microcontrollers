...
///Here is the constructor for the accelerometer
ADXL345::ADXL345() {
  status = ADXL345_OK; //this means no erro
  error_code = ADXL345_NO_ERROR; //right now no error

  gains[0] = 0.00376390; //these were probably tuned so I wouldn't change these
  gains[1] = 0.00376009;
  gains[2] = 0.00349265;
}
