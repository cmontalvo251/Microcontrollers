...
void Adafruit_BME280::setSampling() {
    _measReg.mode     = SENSOR_MODE;
    _measReg.osrs_t   = SENSOR_SAMPLING;
    _measReg.osrs_p   = SENSOR_SAMPLING;
        
    
    _humReg.osrs_h    = SENSOR_SAMPLING;
    _configReg.filter = SENSOR_FILTER;
    _configReg.t_sb   = SENSOR_DURATION;
